...
<body>
	...
	<nav class="navbar navbar-expand-sm bg-light">
  	<ul class="navbar-nav">
    	...
    	<li class="nav-item">
      		<a class="nav-link" href="/show">展示</a>
    	</li>
    	<li class="nav-item">
	...
	<br><br>
	<form name="index" method="post" enctype="multipart/form-data" action="/">
	<div align="center">
				商品名：<input type="text" name="name" required/>
				金額：<input type="number" name="price" maxlength="5"/>
	...
	<table align="center">
		...
		<c:forEach items="${list}" var="Item" varStatus="varStatus">
			<tr>
				...
				<td>
					<label for="T01_PIC_${varStatus.count}">
